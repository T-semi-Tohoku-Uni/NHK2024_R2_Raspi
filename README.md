...
## 姿勢のキャリブレーション
前述のシリアルモニタを開いた状態で背面パネル内側下部についている絶縁CAN基板のリセットスイッチを押す。シリアルモニタの表示でカウントダウンが始まったらロボットをフィールドの上方向に向くようにして静止させる（ロボットを右側面をフィールドの壁に押し当てるとよい）。2秒ほど待つと10からカウントダウンが始まるので0になる前に坂に置く。多分ロボットをフィールド上方向に向けておくといいかも。シリアルモニタにRESULT云々と表示されたらキャリブレーション完了。
